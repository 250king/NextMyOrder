...
CREATE TYPE "public"."DeliveryStatus" AS ENUM('PENDING', 'PUSHED', 'DELIVERED', 'ARRIVED', 'CANCELED');--> statement-breakpoint
...
ALTER TABLE "Address" ADD CONSTRAINT "Address_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE cascade ON UPDATE restrict;--> statement-breakpoint
